...
- WeChat retry (v2026.4.12): FAILED ❌ — `WeChat API error: 40125 invalid appsecret` (rid: 69ddd8ec-1303f080-350fbf84) — **ACTION REQUIRED: refresh WeChat appsecret in PulseAgent platform settings; 24th consecutive failure for v2026.4.12 (runs #114–#137); ZH draft at `.sync/blog-drafts/openclaw-v2026.4.12-zh.md`; blog live at https://pulseagent.io/en/blog/openclaw-v2026-4-12-active-memory-lm-studio-zh**
